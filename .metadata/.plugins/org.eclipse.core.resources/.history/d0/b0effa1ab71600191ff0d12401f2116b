...
public class Test {
	...
	private static final JLabel kodProduktu = new JLabel("Kod produktu", JLabel.CENTER),
			...
			terminPlatnosciText = new JLabel("Termin p³atnoœci: ");
	...
	private static final JButton dodaj = new JButton("dodaj fakturê"), edytuj = new JButton("edytuj fakturê"), usun1 = new JButton("usuñ fakturê"), zamknij = new JButton("zamknij");
	...
	public Test() {
		...
		kolumny1 = new String[] { "Data", "Numer Faktury", "Nabywca", "NIP", "Wartoœæ ogó³em", "Zamkniêta" };
		// wiersze tabeli
		wiersze1 = new Object[][] {};
