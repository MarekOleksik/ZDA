...
public class OknoFaktury extends JFrame {
	...
	private static final JButton dodaj = new JButton("dodaj fakturê"), edytuj = new JButton("edytuj fakturê"), usun = new JButton("usuñ fakturê"), zamknij = new JButton("zamknij");
	...
	public OknoFaktury() {
		...
		kolumny = new String[] { "Data", "Numer Faktury", "Nabywca", "NIP", "Wartoœæ ogó³em", "Zamkniêta" };
		// wiersze tabeli
		wiersze = new Object[][] {};
